...
def main():
    ...
    if st.session_state.step == 1:
        ...
        uploaded_files = st.file_uploader("Upload your CSV files from Semrush > Organic Research > Positions", accept_multiple_files=True, type=["csv"])
        ...
        if uploaded_files:
            ...
            # Set the session state for next step after download
